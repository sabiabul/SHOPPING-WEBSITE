...
namespace SHOPPING_WEBSITE
{
    public partial class Payment : System.Web.UI.Page
    {
        ...
        private void BindOrderProducts()
        {
            string UserIDD = Session["USERID"].ToString();
            DataTable dt = new DataTable();
            SqlConnection conn = new SqlConnection("Data Source=LAPTOP-22LD9A1M\\SQLEXPRESS;Initial Catalog=MyEShoppingDB;Integrated Security=True");
            {
                SqlCommand cmd0 = new SqlCommand("SP_BindCartProducts", conn)
                {
                    CommandType = CommandType.StoredProcedure
                };
